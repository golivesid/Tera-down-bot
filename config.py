...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://newone:newone@newone.cstafst.mongodb.net/?retryWrites=true&w=majority&appName=newone")
DB_NAME = os.environ.get("DATABASE_NAME", "newone")
